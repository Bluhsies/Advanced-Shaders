...
//This fragment shader is for the floor. A separate one has been made for the model.
...
//Uniform values taken in to output colour and depth for the floor. These are set in Lab1.cpp
...
//Forward declare the function for depth testing.
...
//Checks to see if a fragment passes the depth test.
bool doesPassDepthTest()
{
