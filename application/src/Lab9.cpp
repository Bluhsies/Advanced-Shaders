...
//This lab has been combined with lab7 for a more in depth look. The noise compute shader
//Is the same one used in lab7 and provides the same visual outputs.
//This is because I completed my tessellation shaders last, but wanted to use the noise
//texture generated by the compute shader lab as my height map.
...
void Lab9::onUpdate(float timestep)
{
	...
	auto& noiseComputeMat = m_mainRenderer.getComputePass(6).material;
	noiseComputeMat->setValue("octaves", octaves);
	noiseComputeMat->setValue("amplitude", amplitude);
	noiseComputeMat->setValue("frequency", frequency);
	noiseComputeMat->setValue("persistence", persistence);
...
void Lab9::onImGUIRender()
{
	...
	if (ImGui::BeginTabBar("Tabs"))
	{
		...
		if (ImGui::BeginTabItem("Noise"))
		{
			...
			GLuint textureID = m_mainRenderer.getComputePass(6).images[0].texture->getID();
			ImGui::Image((void*)(intptr_t)textureID, imageSize, uv0, uv1);
		...
		if (ImGui::BeginTabItem("ComputeShader"))
		{
