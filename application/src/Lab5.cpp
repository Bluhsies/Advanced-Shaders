...
Lab5::Lab5(GLFWWindowImpl& win) : Layer(win)
{
	...
	floorShaderDesc.vertexSrcPath = "./assets/shaders/Lab5/Lab5GBVertFloor.glsl";
	floorShaderDesc.fragmentSrcPath = "./assets/shaders/Lab5/Lab5GBFragFloor.glsl";
	...
	/*************************
	*  GP pass which fills the GBuffer.
	**************************/
	...
	//Skybox Pass
	//Due to issues with lighting and the skybox, the skybox had to be added to the renderer after the GPass, but
	...
	//Samples from the GBuffer to get the position in world space, normals, colour, specular intensity and depth.
	...
	//For some reason, my PCF version two no longer works in deferred rendering, but PCF version 1 does, hence why
	//the value below has been commented out.
...
void Lab5::onUpdate(float timestep)
{
	...
	//Updated the lightPass and skyboxPass camera views to use the gPass view.
...
void Lab5::onImGUIRender()
{
	...
	//This pass should show the model normals, but they don't appear on my own PC but when I run it in renderdoc, the normals are visible.
